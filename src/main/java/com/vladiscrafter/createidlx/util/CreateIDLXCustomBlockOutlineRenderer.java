...
public class CreateIDLXCustomBlockOutlineRenderer {
    ...
    public static void renderShape(VoxelShape s, PoseStack ms, VertexConsumer vb, Type type) {
        boolean isCustomOutlineForDisplayLinksEnabled = CIDLXConfigs.client.enableCustomOutlineForDisplayLinks.get();
        boolean isDifferentOutlineForInvalidDisplayLinksEnabled = CIDLXConfigs.client.enableDifferentOutlineForInvalidDisplayLinks.get();
        float customOutlineAlpha = CIDLXConfigs.client.customOutlineAlpha.getF();
        ...
        s.forAllEdges((x1, y1, z1, x2, y2, z2) -> {
            ...
            if (isCustomOutlineForDisplayLinksEnabled && (type == Type.DISPLAY_LINK || (type == Type.DISPLAY_LINK_INVALID && !isDifferentOutlineForInvalidDisplayLinksEnabled))) {
                r = 131f;
                g = 239f;
                b = 145f;
            } else if (isCustomOutlineForDisplayLinksEnabled && type == Type.DISPLAY_LINK_INVALID) {
                r = 239f;
                g = 71f;
                b = 85f;
            }
