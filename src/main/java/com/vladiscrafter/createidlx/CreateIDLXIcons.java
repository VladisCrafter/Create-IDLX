...
public class CreateIDLXIcons implements ScreenElement {

    public static final ResourceLocation ICON_ATLAS = CreateIDLX.asResource("textures/gui/createidlx_icons.png");
    ...
    private static CreateIDLXIcons next() {
        return new CreateIDLXIcons(++x, y);
    }

    private static CreateIDLXIcons newRow() {
        return new CreateIDLXIcons(x = 0, ++y);
    }
